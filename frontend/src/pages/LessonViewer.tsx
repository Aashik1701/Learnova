...
import { Brain, ArrowLeft, BookOpen, CheckCircle2, Lock } from "lucide-react";
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      ) : idx === 0 || lesson.chapters[idx - 1].completed ? (
                      ...
                      <div className="flex-1">
                        ...
                        <div className={`text-xs ${selectedChapter === chapter.id ? 'opacity-90' : 'text-muted-foreground'}`}>
                          {chapter.title}
                        </div>
                      </div>
                    </div>
